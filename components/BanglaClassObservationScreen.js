    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
              ...
              <View style={{ flexDirection: "row", padding: 10 }}>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    <View style={{ flex: 1 }}>
                      ...
                      <Picker
                        ...
                        itemStyle={{ color: "white" }}
                      >
                        <Picker.Item label={"ক"} value={"1"} />
                        <Picker.Item label={"খ"} value={"2"} />
                        <Picker.Item label={"গ"} value={"3"} />
                      </Picker>
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Picker
                    ...
                    itemStyle={{ color: "white" }}
                  >
                    <Picker.Item label={"শনিবার"} value={"Saturday"} />
                    <Picker.Item label={"রবিবার"} value={"Sunday"} />
                    <Picker.Item label={"সোমবার"} value={"Monday"} />
                    <Picker.Item label={"মঙ্গলবার"} value={"Tuesday"} />
                    <Picker.Item label={"বুধবার"} value={"Wednesday"} />
                    <Picker.Item label={"বৃহস্পতিবার"} value={"Thursday"} />
                  </Picker>
                </View>
              </View>
              <View style={{ flexDirection: "row", padding: 10 }}>
            ...
            <Card style={{ padding: 10, margin: 10, flex: 1 }}>
              <View style={{ padding: 5 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                  <View style={{ flex: 1, padding: 2 }}>
                    <TextInput
                      style={{ height: 120, padding: 5, borderWidth: 1 }}
                      placeholder=""
                    ></TextInput>
                  </View>
                </View>
          ...
          {/* <View style={{ padding: 10 }}>
            <Text style={styles.bigRedText}>পরিদর্শক এর তথ্যঃ </Text>
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1, padding: 2 }}>
                <View style={{ padding: 5 }}>
                  <View style={{ flexDirection: "row" }}>
                    <View style={{ flex: 1, padding: 2 }}>
                      <Text>এল এফ এর নামঃ </Text>
                    </View>
                    <View style={{ flex: 1, padding: 2 }}>
                      <TextInput
